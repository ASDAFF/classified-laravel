...
@section('content')
    ...
    <h3 class="title-3 text-success">
        <i class="icon-check"></i> <a href="https://clck.ru/EFSmf" target="_blank">BINGO!</a> Congratulations, you've successfully installed LaraClassified (Classified Ads Web Application)
    </h3>
