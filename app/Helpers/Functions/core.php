 ...
 * @return mixed
 *
 * By LaraClassified Users
 */
function doClean($string)
{
	$string = str_replace('❤️', '', $string);
	$string = str_ireplace('Iᒪ', 'il', $string);
	$string = str_ireplace('➋', '2', $string);
	$string = str_ireplace('➍', '4', $string);
	$string = str_ireplace('➆', '7', $string);
	$string = str_replace(' - ', '-', $string);
	$string = str_replace('ℹ', 'i', $string);
	$string = str_replace('🅾', 'o', $string);
	$string = str_replace('🅰', 'a', $string);
	$string = str_replace('🅱️', 'b', $string);
	$string = str_replace('🅿️', 'p', $string);
	$string = str_replace('✘', 'x', $string);
	$string = str_replace('ℴ', 'o', $string);
	$string = str_replace('ⓢ', 's', $string);
	$string = str_replace('ⓦ', 'w', $string);
	$string = str_replace('ⓔ', 'e', $string);
	$string = str_replace('ⓣ', 't', $string);
	$string = str_replace('ყ', 'y', $string);
	$string = str_replace('ѕ', 's', $string);
	$string = str_replace('м', 'm', $string);
	$string = str_replace('т', 't', $string);
	$string = str_replace('н', 'h', $string);
	$string = str_replace('ι', 'i', $string);
	$string = str_replace('ε', 'e', $string);
	$string = str_replace('ƒ', 'f', $string);
	$string = str_replace('¢', 'c', $string);
	$string = str_replace('†', 't', $string);
	$string = str_replace('ρ', 'p', $string);
	$string = str_replace('℮', 'e', $string);
	$string = str_replace('δ', 'o', $string);
	$string = str_replace('ϻ', 'm', $string);
	$string = str_replace('Ʀ', 'r', $string);
	$string = str_replace('ƴ', 'y', $string);
	$string = str_replace('ɢ', 'g', $string);
	$string = str_replace('Ƭ', 't', $string);
	$string = str_ireplace('ᒪ', 'l', $string);
	$string = str_ireplace('ᑌ', 'u', $string);
	$string = str_ireplace('ᑭ', 'p', $string);
	$string = str_ireplace('ᗩ', 'a', $string);
	$string = str_ireplace('ᗰ', 'm', $string);
	$string = str_ireplace('ᑎ', 'n', $string);
	$string = str_ireplace('ᖇ', 'r', $string);
	$string = str_ireplace('ᖴ', 'f', $string);
	$string = str_ireplace('ᑕ', 'c', $string);
	$string = str_ireplace('ʋ', 'u', $string);
	$string = str_ireplace('ƨ', 's', $string);
	$string = str_ireplace('β', 'b', $string);
	$string = str_ireplace('ℛ', 'r', $string);
	$string = str_ireplace('ℳ', 'm', $string);
	$string = str_ireplace('η', 'n', $string);
	$string = str_ireplace('∂', 'd', $string);
	$string = str_ireplace('ë', 'e', $string);
	$string = str_ireplace('ę', 'e', $string);
	$string = str_ireplace('ý', 'y', $string);
	$string = str_ireplace('Ý', 'Y', $string);
	$string = str_ireplace('û', 'u', $string);
	$string = str_ireplace('ğ', 'g', $string);
	$string = str_ireplace('Ť', 'T', $string);
	$string = str_ireplace('å', 'a', $string);
	$string = str_ireplace('ģ', 'g', $string);
	$string = str_ireplace('ä', 'a', $string);
	$string = str_ireplace('╠╣', 'h', $string);
	$string = str_ireplace('G͢', 'g', $string);
	$string = str_ireplace('к', 'k', $string);
	$string = str_ireplace('и', 'n', $string);
	$string = str_ireplace('я', 'r', $string);
	$string = str_ireplace('о', 'o', $string);
	$string = str_ireplace('α', 'a', $string);
	$string = str_ireplace('v', 'v', $string);
	$string = str_ireplace('ℓ', 'l', $string);
	$string = str_ireplace('в', 'b', $string);
	$string = str_ireplace('є', 'e', $string);
	$string = str_ireplace('σ', 'o', $string);
	$string = str_ireplace('ω', 'w', $string);
	$string = str_ireplace('υ', 'u', $string);
	$string = str_ireplace('ν', 'v', $string);
	$string = str_ireplace('Т', 't', $string);
	$string = str_ireplace('ʏ', 'y', $string);
	...
	$string = str_replace('Ł', 'l', $string);
	$string = str_replace('į', 'i', $string);
	$string = str_replace('Ạ', 'a', $string);
	$string = str_replace('Ẹ', 'e', $string);
	$string = str_replace('у', 'y', $string);
	$string = str_replace('τ', 't', $string);
	$string = str_replace('θ', 'o', $string);
	$string = str_replace('γ', 'y', $string);
	$string = str_replace('ß', 'b', $string);
	$string = str_replace('ｐ', 'p', $string);
	$string = str_replace('ｅ', 'e', $string);
	$string = str_replace('ｔ', 't', $string);
	$string = str_replace('ｉ', 'i', $string);
	$string = str_replace('Ꮆ', 'g', $string);
	$string = str_replace('Ꮎ', 'o', $string);
	$string = str_replace('Ꮢ', 'r', $string);
	$string = str_replace('Ꭼ', 'e', $string);
	$string = str_replace('Ꮜ', 'u', $string);
	$string = str_replace('Ꭶ', 's', $string);
	$string = str_replace('ષ', 'u', $string);
	$string = str_replace('૮', 'c', $string);
	$string = str_replace('🇸', 's', $string);
	$string = str_replace('🇪', 'e', $string);
	...
	$string = str_replace('ĸ', 'k', $string);
	$string = str_replace('ᒍ', 'j', $string);
	$string = str_replace('ᔕ', 's', $string);
	$string = str_replace('ᐯ', 'v', $string);
	$string = str_replace('ᗪ', 'd', $string);
	$string = str_replace('᙭', 'x', $string);
	$string = str_replace('ᕼ', 'h', $string);
	$string = str_replace('ɛ', 'e', $string);
	$string = str_replace('ɨ', 'i', $string);
	$string = str_replace('ʟ', 'l', $string);
	$string = str_replace('ɮ', 'b', $string);
	...
	$string = str_replace('🇪‌', 'e', $string);
	$string = str_replace('🇩', 'd', $string);
	$string = str_replace('ℰ', 'e', $string);
	$string = str_replace('ϰ', 'x', $string);
	$string = str_replace('℘', 'p', $string);
	$string = str_replace('ґ', 'r', $string);
	$string = str_replace('ḯ', 'i', $string);
	$string = str_replace('ℯ', 'e', $string);
	$string = str_replace('ⓂE', 'me', $string);
	$string = str_replace('®', 'r', $string);
	$string = str_replace('հ', 'h', $string);
	$string = str_replace('ʀ', 'r', $string);
	$string = str_replace('➀', '1', $string);
	$string = str_replace('👀', 'oo', $string);
	$string = str_replace('ᗷ', 'b', $string);
	$string = str_replace('Ꮛ', 'e', $string);
	$string = str_replace('ҽ', 'e', $string);
